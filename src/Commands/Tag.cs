...
public class SlashTagsEdit : ApplicationCommandModule
{
    ...
    public static async Task TagAddCommand(InteractionContext ctx, [Option("tagname", "Tag to be added")] string tagname)
    {
        Utils.LogUserCommand(ctx);
    ...
    public static async Task TagRemoveCommand(InteractionContext ctx, [Option("tagname", "Tag to be removed")] string tagname)
    {
        Utils.LogUserCommand(ctx);
    ...
    public static async Task TagListCommand(InteractionContext ctx)
    {
        Utils.LogUserCommand(ctx);
        try
        {
    ...
    public static async Task TagAliasCommand(InteractionContext ctx, [Option("tagname", "Tag to be aliased")] string tagname, [Option("alias1", "First alias")] string alias1, [Option("alias2", "Second alias")] string alias2 = null, [Option("alias3", "Third alias")] string alias3 = null)
    {
        Utils.LogUserCommand(ctx);
    ...
    public static async Task TagEditCommand(InteractionContext ctx, [Option("tagname", "Tag to be modified")] string tagname)
    {
        Utils.LogUserCommand(ctx);
    ...
    public static async Task TagRemoveAlias(InteractionContext ctx, [Option("tagname", "Tag to be modified")] string tagName)
    {
        Utils.LogUserCommand(ctx);
        try
        {
    ...
    public static async Task TagRenameCommand(InteractionContext ctx, [Option("tagname", "Tag to be modified")] string oldname, [Option("newname", "The new name for the tag")] string newname)
    {
        Utils.LogUserCommand(ctx);
    ...
    public static async Task TagAddAuthor(InteractionContext ctx, [Option("tagname", "Tag to change the author")] string tagName, [Option("authorname", "Pick author of tag")] string authorName)
    {
        Utils.LogUserCommand(ctx);
        try
        {
    ...
    public static async Task TagColorPicking(InteractionContext ctx, [Option("tagname", "Tag to set the color")] string tagName, [Option("colorName", "just a comment")] TagColorValue? colorName = null)
    {
        Utils.LogUserCommand(ctx);
        try
        {
    ...
    public static async Task TagImagePicking(InteractionContext ctx, [Option("tagName", "Tag to add the thumbnail")] string tagName, [Option("Image", "Link to image")] string imageLink)
    {
        Utils.LogUserCommand(ctx);
        try
        {
    ...
    public static async Task TagImageRemoving(InteractionContext ctx, [Option("tagName", "Tag with thumbnail")] string tagName)
    {
        Utils.LogUserCommand(ctx);
        try
        {
    ...
    public static async Task TagThumbnailPicking(InteractionContext ctx, [Option("tagname", "Tag to add the thumbnail")] string tagName, [Option("Thumbnail", "Link to image")] string thumbnailLink)
    {
        Utils.LogUserCommand(ctx);
        try
        {
    ...
    public static async Task TagThumbnailRemoving(InteractionContext ctx, [Option("tagname", "Tag with thumbnail")] string tagName)
    {
        Utils.LogUserCommand(ctx);
        try
        {
