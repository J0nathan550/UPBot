...
public class SlashGame : ApplicationCommandModule
{
    ...
    private static List<ulong> tttPlayers = [];
    ...
    public static async Task TicTacToeGame(InteractionContext ctx, [Option("opponent", "Select a Discord user to play with (keep empty to play with the bot)")] DiscordUser opponent = null)
    {
        Utils.LogUserCommand(ctx);
