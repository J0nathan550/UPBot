...
public static class Utils
{
    ...
    private static readonly Dictionary<string, LogInfo> logs = [];

    public static string GetVersion()
    {
        return vmajor + "." + vminor + "." + vbuild + vrev + " - 2023/09/02";
    }
    ...
    {
        if (!logs.TryGetValue(guild, out LogInfo value)) return null;
        return value.path;
    }
